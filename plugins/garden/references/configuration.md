...
review_on:
  ...
  - major-release
---
<!-- Generated from docs/reference/configuration.md. Do not edit directly. Run sync_references.py --write to update. -->
...
and validation result, see [report-schema.md](https://github.com/vshuraeff/garden/blob/master/docs/reference/report-schema.md).
...
[platform-support.md](https://github.com/vshuraeff/garden/blob/master/docs/reference/platform-support.md) for the resulting Windows constraint.
...
`scan.roots`. See [report-schema.md](https://github.com/vshuraeff/garden/blob/master/docs/reference/report-schema.md) for the report's `scan` object
